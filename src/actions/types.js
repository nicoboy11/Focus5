...
export const LISTA_PROYECTOS_SUCESS = 'lista_proyectos_success';
export const LISTA_PROYECTOS_FAILED = 'lista_proyectos_failed';
...
export const PROYECT_TEXT = 'proyect_text';
export const PROYECT_FEC_INICIO = 'proyect_fec_inicio';
export const PROYECT_FEC_FIN = 'proyect_fec_fin';
export const PROYECT_FEC_OPEN = 'proyect_fec_open';
export const PROYECT_STATUS = 'proyect_status';
export const PROYECTO_ACTUAL = 'proyecto_actual';
export const PROYECTO_ACTUALIZA = 'proyecto_actualiza';
export const PROYECTO_ACTUAL_GUARDAR = 'proyecto_actual_guardar';
...
export const TR_CALENDAR_SUCCESS = 'tr_calendar_success';
